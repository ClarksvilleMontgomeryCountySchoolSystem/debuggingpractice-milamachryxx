...
candy_total = candy_price * int(candy_quantity)
...
soda_total = soda_price * int(soda_quantity)
...
gas_price = 3.25
gallons = gallons_str
gas_total = gas_price * float(gallons)
...
deli_price = 8.99
pounds = pounds_str
deli_total = deli_price * float(pounds)
...
lottery_total = lottery_price * int(lottery_quantity)
